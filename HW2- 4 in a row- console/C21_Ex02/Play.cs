...
namespace C21_Ex02
{
    internal class Play
    {
        ...
        internal void Start()
        {
            ...
            // $G$ CSS-999 (-2) The using of the word "true" here is redundant.
            while (m_PlayAgain == true)
            {
                while (game.GameBoardIsNotFull())
                {
                    // $G$ CSS-999 (-5) If you use number as condition --> then you should have use constant here.
                    if (m_PlayerWin == 0)
                    {
        ...
        private int getNBoardRow()
        {
            ...
            // $G$ NTT-002 (-5) You should have used int.TryParse here. Instead of checking each number - check range.
        ...
        // $G$ DSN-004 (-5) Redundant code duplication, the difference between the methods is to small.
        ...
        // $G$ DSN-999 (-7) This method should be implement in the logical game part and not in UI part.
        ...
        // $G$ DSN-999 (-5) This method is too long, should be divided to several methods.
        private void setMovePlayer2(Game i_game)
         {
             if (!m_TheComputerIsPlay)
             {
                ...
                // $G$ DSN-004 (-5) Redundant code duplication, should call getMovePlayer1.
                 int n_col = inputMoveCol(i_game);
                 int n_row = getRowWithCol(i_game, n_col);
